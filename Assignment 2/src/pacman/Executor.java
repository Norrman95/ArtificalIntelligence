...
import pacman.controllers.ANN.AssignmentController;
...
{	
	...
	public static void main(String[] args)
	{
		...
		int numTrials=10;
		exec.runExperiment(new AssignmentController(),new RandomGhosts(),numTrials);
		//exec.runGame(new AssignmentController(),new RandomGhosts(),true,5);
...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
    ...
    public void runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
		...
		for(int i=0;i<trials;i++)
		{
			...
			System.out.println(i+"\t"+game.getScore()+ "    " + pacman.controllers.ANN.Constants.inputWeights);		
			//
		}
